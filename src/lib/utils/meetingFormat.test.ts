...
describe('dateGroupLabel', () => {
  ...
  it('lets last week win over last month when a week straddles the turn of the month', () => {
    // THE case. Now is Wed 8 July; last week is Sun 28 June – Sat 4 July, which
    // is mostly June. A June date inside that week is *Last week*, not *Last
    // month* — the rules are ordered, and reordering them breaks exactly this.
...
describe('formatTime', () => {
  ...
  it('truncates rather than rounding', () => {
    ...
    // has not happened yet, and seeking there would land past the mark.
