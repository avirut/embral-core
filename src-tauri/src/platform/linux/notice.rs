...
//!
//! Best-effort here, and the two display servers land differently:
//!
...
//!   client cannot take focus it was not given — so the guarantee holds for
//!   free and these calls are simply inert.
//!
